...
namespace XBDataProvider
{
    ...
    {
        public static int SaveLocation(string LocationCode, string name, string PermanantAccountNo, string FormationDate, string TaxId, string RegistrationNumber,
                                        ...
                                        string city, string area, string zipCode, string country, string state, String fax)
        {
            try
            {
                ...
                return DataProvider.ExecuteSqlProcedure(connString, "dbo.sp_LocationMst_xpins", cmd);
            }
            catch (Exception ex)
            {
                return -1;
