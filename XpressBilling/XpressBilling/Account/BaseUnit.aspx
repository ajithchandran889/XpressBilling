    ...
    <div class="page-content">
        <div class="row content-holder">
            <div class="col-sm-12 col-md-12">
              ...
              <span class="icon-wrap pull-left"> <a href="EditBaseUnit"><i class="glyphicon glyphicon-plus "></i></a></span>
               <span class="icon-wrap pull-left"> <i class="glyphicon glyphicon-trash"></i></span>
                    ...
                    <asp:GridView ID="listBaseUnit" runat="server" CssClass="table" AllowPaging="true"
                        OnPageIndexChanging="listBaseUnitPageIndexChanging" PageSize="2" AutoGenerateColumns="false">
