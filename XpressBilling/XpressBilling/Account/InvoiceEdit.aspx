...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="row content-holder">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="page-header">Invoice Edit</div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-2">
                        <asp:TextBox runat="server" ID="InvoiceDate" class="form-control required" placeholder="Date" ClientIDMode="Static"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-2">
                        <asp:TextBox runat="server" ID="Amount" class="form-control required" placeholder="Validity" ClientIDMode="Static"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-2">
                        <asp:TextBox runat="server" ID="AvailableCredit" class="form-control" placeholder="Available Credit" ClientIDMode="Static"></asp:TextBox>
                ...
                <div class="form-group">
                    <div class="col-xs-10 col-md-8">
                        ...
                        <a id="CancelBtn" href="/Account/Invoice" runat="server" class="btn btn-primary pull-right">Cancel</a>
                    </div>
                </div>
                <asp:Panel runat="server" ID="gridDetails">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-8">
                        <div class="form-group ">
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-8">
                                <asp:TextBox runat="server" ID="TextBox1" class="form-control gridTxtBox" placeholder="Ship To Address" TextMode="MultiLine" ClientIDMode="Static"></asp:TextBox>
                            </div>
                        </div>
                    </div>
