            ...
            <div class="col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-10 col-md-8">
                        <asp:Button ID="saveEmployee" runat="server" ClientIDMode="Static" class="btn btn-primary pull-right" Text="Save" OnClick="SaveClick" />
                        <a href="/Account/Employee.aspx" class="btn btn-primary pull-right">Cancel</a><label id="lblMsg" style="color:red;" runat="server"></label>
                    </div>
