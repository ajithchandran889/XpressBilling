...
namespace XpressBilling.Account
{
    public partial class RptSalesInvoice : System.Web.UI.Page
    {
        ...
        protected void SaveClick(object sender, EventArgs e)
        {
           ...
           // lblBankCode.InnerText = objAccountDetails.BankCode;
            retunValue = XBDataProvider.RptSalesInvoice.SaveRptSalesInvoice(CompanyCode.Value, header, declaration, footer, reportID, copies,
        ...
        {
            DataTable dtTable = XBDataProvider.RptSalesInvoice.GetInvoiceParameters(hdncompanyCode);
