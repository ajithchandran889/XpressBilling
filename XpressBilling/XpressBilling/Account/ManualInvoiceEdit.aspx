                        ...
                        <asp:GridView ID="ManualInvoiceDetail" runat="server" class="table" ClientIDMode="Static" ShowFooter="False" AutoGenerateColumns="false" DataKeyNames="ID">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Rate"  ControlStyle-Width="70">
                                    <ItemTemplate>
                                        <asp:TextBox ID="MIItemRate" class="form-control MIItemRate " ClientIDMode="Static" runat="server" Text='<%# Bind("Rate") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Quantity"  ControlStyle-Width="70">
                                    <ItemTemplate>
                                        <asp:TextBox ID="MIQuantity" class="form-control MIQuantity " ClientIDMode="Static" runat="server" Text='<%# Bind("Qty") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Disc%"  ControlStyle-Width="70">
                                    <ItemTemplate>
                                        <asp:TextBox ID="MIDiscPer" class="form-control " ClientIDMode="Static" runat="server" Text='<%# Bind("DiscountPercentage") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Disc Amt"  ControlStyle-Width="70">
                                    <ItemTemplate>
                                        <asp:TextBox ID="MIDiscAmt" class="form-control MIDiscAmt" ClientIDMode="Static" runat="server" Text='<%# Bind("DiscountAmt") %>'></asp:TextBox>
                                        
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Tax%"  ControlStyle-Width="70">
                                    <ItemTemplate>
                                        <asp:TextBox ID="MITaxPer" class="form-control MITaxPer" ClientIDMode="Static" runat="server" Text='<%# Bind("TaxPercentage") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Tax Amt"  ControlStyle-Width="70">
                                    <ItemTemplate>
                                        <asp:TextBox ID="MITaxAmt" class="form-control MITaxAmt" ClientIDMode="Static" runat="server" Text='<%# Bind("TaxAmount") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
