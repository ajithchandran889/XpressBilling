            ...
            <div class="col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-10 col-md-8">
                        <a href="/Account/Manufacturer.aspx" class="btn btn-primary pull-left">Cancel</a><asp:Button ID="saveManufacturer" runat="server" ClientIDMode="Static" class="btn btn-primary pull-left" Text="Save" OnClick="SaveClick" />
                     </div>
                </div>
            </div>
        </div>
